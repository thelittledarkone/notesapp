...
$message .= "http://seraphimvirtualservices.com/NotesApp/resetpassword.php?user_id=$user_id&key=$key";
//<!--        If email sent successfully-->
if(mail($email, 'Reset your Password', $message, 'From:'.'cs@seraphimvirtualservices.com')){
//<!--            Print success-->
